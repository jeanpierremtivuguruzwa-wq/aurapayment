...
const PERMISSION_META: Record<AgentPermission, { label: string; icon: string; desc: string }> = {
  transactions:          { label: 'Transactions',         icon: '📊', desc: 'View and manage all payment transactions' },
  orders:                { label: 'Orders',               icon: '📦', desc: 'View, complete and cancel customer orders' },
  users:                 { label: 'User Management',      icon: '👤', desc: 'View registered users and their details' },
  currency:              { label: 'Currency Pairs',       icon: '💱', desc: 'View and edit currency exchange rates' },
  payments:              { label: 'Payment Methods',      icon: '💳', desc: 'View and manage payment methods' },
  cardholders:           { label: 'Cardholders',          icon: '👥', desc: 'View and manage cardholder records' },
  'cardholder-activity': { label: 'Cardholder Activity',  icon: '📈', desc: 'View cardholder transaction activity history' },
  chat:                  { label: 'AuraChat',             icon: '💬', desc: 'Access the internal Aura chat system' },
