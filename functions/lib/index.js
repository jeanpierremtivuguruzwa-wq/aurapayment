...
export const syncCurrencyRates = scheduler.onSchedule({
    ...
    const apiKey = (_b = (_a = settingsSnap.data()) === null || _a === void 0 ? void 0 : _a.currencyLayerKey) !== null && _b !== void 0 ? _b : "";
    if (!apiKey) {
    ...
    if (!json.success || !json.quotes) {
        console.error("syncCurrencyRates: API error —", (_c = json.error) === null || _c === void 0 ? void 0 : _c.info);
        return;
    }
    ...
    for (const doc of pairsSnap.docs) {
        ...
        const spread = (_d = pair.spread) !== null && _d !== void 0 ? _d : 0;
        const spreadType = (_e = pair.spreadType) !== null && _e !== void 0 ? _e : "flat";
        const newRate = parseFloat((spreadType === "percent"
            ? market * (1 - spread / 100)
            : market - spread).toFixed(6));
        if (newRate <= 0) {
            skipped++;
            continue;
        }
...
export const awardBarsOnOrderComplete = firestoreTriggers.onDocumentUpdated("orders/{orderId}", async (event) => {
    ...
    const userEmail = (_d = after.userEmail) !== null && _d !== void 0 ? _d : "";
    const userName = after.senderName || after.recipientName || "";
    const sendAmount = Number((_f = (_e = after.sendAmount) !== null && _e !== void 0 ? _e : after.amount) !== null && _f !== void 0 ? _f : 0);
    const sendCurrency = (_g = after.sendCurrency) !== null && _g !== void 0 ? _g : "USD";
    if (!userId) {
    ...
    const settings = {
        cashbackRate: (_j = (_h = settingsSnap.data()) === null || _h === void 0 ? void 0 : _h.cashbackRate) !== null && _j !== void 0 ? _j : 0.02,
        minOrderForCashback: (_l = (_k = settingsSnap.data()) === null || _k === void 0 ? void 0 : _k.minOrderForCashback) !== null && _l !== void 0 ? _l : 0,
        maxCashbackPerOrder: (_o = (_m = settingsSnap.data()) === null || _m === void 0 ? void 0 : _m.maxCashbackPerOrder) !== null && _o !== void 0 ? _o : 500,
        barsName: (_q = (_p = settingsSnap.data()) === null || _p === void 0 ? void 0 : _p.barsName) !== null && _q !== void 0 ? _q : "Aura Bars",
        barsSymbol: (_s = (_r = settingsSnap.data()) === null || _r === void 0 ? void 0 : _r.barsSymbol) !== null && _s !== void 0 ? _s : "bars",
    };
    ...
    await db.runTransaction(async (tx) => {
        ...
        const prevBalance = Number((_a = existing === null || existing === void 0 ? void 0 : existing.balance) !== null && _a !== void 0 ? _a : 0);
        const prevLifetime = Number((_b = existing === null || existing === void 0 ? void 0 : existing.lifetimeEarned) !== null && _b !== void 0 ? _b : 0);
        ...
        tx.set(walletRef, {
            ...
            frozen: (_c = existing === null || existing === void 0 ? void 0 : existing.frozen) !== null && _c !== void 0 ? _c : 0,
...
export const sendPasswordResetCustomEmail = functions.onCall({ cors: true }, async (request) => {
    var _a, _b, _c, _d;
    const db = admin.firestore();
    ...
    const settingsSnap = await db.collection("appSettings").doc("main").get();
    const geminiKey = (_d = (_c = settingsSnap.data()) === null || _c === void 0 ? void 0 : _c.geminiKey) !== null && _d !== void 0 ? _d : "";
    let htmlBody;
    if (geminiKey) {
        try {
